...
if(preg_match('/(?i)msie [1-9]/',$_SERVER['HTTP_USER_AGENT']) === 0) {
	...
	if (!empty($post) && is_object($post)) {
		...
		$side_area_class .= (strcmp($dfd_ronneby['side_area_bg_dark'], '1') === 0) ? ' dfd-background-dark' : '';
		...
		$side_area_css = '';
		$side_area_bg_color = $dfd_ronneby['side_area_bg_color'];
		$side_area_bg_image = $dfd_ronneby['side_area_bg_image']['url'];
		$side_area_bg_position = $dfd_ronneby['side_area_bg_position'];
		$side_area_bg_repeat = $dfd_ronneby['side_area_bg_repeat'];
			...
			<?php } else { ?>
				<section id="side-area" class="<?php echo esc_attr($side_area_class); ?>" style="<?php echo $side_area_css; ?>">
					...
					<div class="side_area_title">
						<?php if ($dfd_ronneby['side_area_title']['url']) { ?>
					...
					<div class="side-area-bottom">
						...
						<?php endif;*/ ?>
						<?php if (strcmp($dfd_ronneby['side_area_soc_icons'], '1') === 0) : ?>
						...
						<?php endif; ?>
						<?php if ($dfd_ronneby['side_area_copyright']) : ?>
