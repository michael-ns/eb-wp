...
$top_panel_inner_class = (isset($dfd_ronneby['top_panel_inner_style']) && !empty($dfd_ronneby['top_panel_inner_style'])) ? $dfd_ronneby['top_panel_inner_style'] : 'dfd-tablet-hide';
$page_show_top_panel = '';
