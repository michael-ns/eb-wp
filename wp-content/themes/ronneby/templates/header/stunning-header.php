...
if (strlen($custom_head_bg_img_position)==0) {
	$custom_head_bg_img_position = $dfd_ronneby['stan_header_bg_img_position'];
}

if (strlen($custom_head_stan_header_fixed)==0) {
	$custom_head_stan_header_fixed = $dfd_ronneby['stan_header_fixed'];
}

if (strlen($custom_head_stan_header_bgcheck)==0) {
	$custom_head_stan_header_bgcheck = $dfd_ronneby['stan_header_bgcheck'];
}

if (strlen($custom_head_stan_header_text_alignment)==0) {
	$custom_head_stan_header_text_alignment = $dfd_ronneby['stan_header_text_align'];
}
...
$custom_head_stan_header_breadcrumbs = true;
if (isset($dfd_ronneby['stan_header_breadcrumbs']) && strcmp($dfd_ronneby['stan_header_breadcrumbs'], '0') === 0) {
	$custom_head_stan_header_breadcrumbs = false;
}
...
if (isset($dfd_ronneby['stan_header']) && $dfd_ronneby['stan_header']):
	...
	if ($custom_head_stan_header_fixed) {
	...
	if ($custom_head_stan_header_bgcheck) {
...
?>
<div id="stuning-header" style="<?php echo $stuning_header_style; ?>">
		...
		<div class="row">
			<div class="twelve columns">
				<div class="page-title-inner <?php echo esc_attr($page_title_inner_class); ?>" <?php echo $custom_stunning_header_height_css; ?>>
					<div class="page-title-inner-wrap">
						...
						<?php /*if (is_single()): ?>
							<div class="dfd-meta-wrap clearfix">
								<?php get_template_part('templates/entry-meta', 'post-single'); ?>
					...
					<?php if ($custom_head_stan_header_breadcrumbs) { ?>
