<?php
    ...
    <div class="flex-video  widescreen">
        <iframe width="640" height="460" src="https://www.youtube.com/embed/<?php echo get_post_meta($post->ID, 'post_youtube_video_url', true); ?>?wmode=opaque" class="youtube-video" allowfullscreen></iframe>
     </div>
<?php }
...
if (has_post_thumbnail()) {
    ...
    $article_image = dfd_aq_resize($img_url, 500, 300, true, true, true);
	if(!$article_image) {
