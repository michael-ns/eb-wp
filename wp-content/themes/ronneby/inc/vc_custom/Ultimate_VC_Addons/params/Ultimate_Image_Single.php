...
if(!class_exists('Ult_Image_Single'))
{
  class Ult_Image_Single
  {
    function __construct()
    {
		...
		{
			  add_shortcode_param('ult_img_single', array($this, 'ult_img_single_callback'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/ultimate-image_single.js');
		}
