	...
	class Ultimate_DateTime_Picker_Param
	{
		function __construct() {	
			if(function_exists('add_shortcode_param')) {
				add_shortcode_param('datetimepicker' , array($this, 'datetimepicker'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/js/bootstrap-datetimepicker.min.js');
			}
		}
