...
if(!class_exists('Ultimate_Margin_Param'))
{
	class Ultimate_Margin_Param
	{
		...
		{	
			...
			{
				add_shortcode_param('ultimate_margins', array($this, 'ultimate_margins_param'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/vc-headings-param.js');
			}
		}
