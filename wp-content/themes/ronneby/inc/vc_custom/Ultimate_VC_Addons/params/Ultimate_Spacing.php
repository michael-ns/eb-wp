...
if(!class_exists('Ult_Spacing'))
{
  class Ult_Spacing
  {
    function __construct()
    {
		...
		{
			  add_shortcode_param('ultimate_spacing', array($this, 'ultimate_spacing_callback'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/ultimate-spacing.js');
		}
    }
