  ...
  class Ultimate_BoxShadow
  {
    function __construct()
    {
		if(function_exists('add_shortcode_param')) {
			add_shortcode_param('ultimate_boxshadow', array($this, 'ultimate_boxshadow_callback'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/vc-box-shadow-param.js');
		}
    ...
    function ultimate_boxshadow_param_scripts($hook) {
		wp_register_style( 'ultimate_boxshadow_param_css',get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/css/vc_param_boxshadow.css');
