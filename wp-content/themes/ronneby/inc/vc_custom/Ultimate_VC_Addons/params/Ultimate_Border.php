	...
	class Ultimate_Border {
		function __construct() {
			...
			if(function_exists('add_shortcode_param')) {
				add_shortcode_param('ultimate_border', array($this, 'ultimate_border_callback'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/ultimate-border.js');
			}
		}
		...
		function ultimate_border_param_scripts($hook) {
			wp_register_style("ultimate-border-style",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/css/ultimate_border.css');
