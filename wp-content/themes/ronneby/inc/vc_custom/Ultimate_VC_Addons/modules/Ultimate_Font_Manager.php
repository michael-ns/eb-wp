...
if(!class_exists('Ultimate_Google_Font_Manager'))
{
	class Ultimate_Google_Font_Manager
	{
		function __construct()
		{
			...
			{
				add_shortcode_param('ultimate_google_fonts', array($this, 'ultimate_google_fonts_settings'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/vc-google-fonts-param.js');
