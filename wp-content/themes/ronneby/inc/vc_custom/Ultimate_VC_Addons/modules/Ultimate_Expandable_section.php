	...
	if(!class_exists('AIO_ultimate_exp_section')) {
		class AIO_ultimate_exp_section{
			function __construct(){
				...
				add_action('admin_init',array($this,'ultimate_ultimate_exp_section'));
				...
				if(function_exists('vc_map')) {
					vc_map(
						array(
							...
							'front_enqueue_css' => get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/css/expandable-section.css',
							'front_enqueue_js' => get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/js/expandable-section.js',
							'controls' => 'full',
