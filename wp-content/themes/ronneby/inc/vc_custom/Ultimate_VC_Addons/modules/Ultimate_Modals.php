...
if(!class_exists('Ultimate_Modals'))
{
	class Ultimate_Modals
	{
		...
		{
			wp_register_script("ultimate-modernizr",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/modernizr.custom.min.js',array('jquery'),ULTIMATE_VERSION);
			//wp_register_script("ultimate-classie",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/classie.min.js',array('jquery'),ULTIMATE_VERSION);
			//wp_register_script("ultimate-snap-svg",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/snap.svg.min.js',array('jquery'),ULTIMATE_VERSION);
			//wp_register_script("ultimate-frongloop",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/froogaloop2.min.js',array('jquery'),ULTIMATE_VERSION);
			//wp_register_script("ultimate-modal",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/modal.min.js',array('jquery'),ULTIMATE_VERSION);
			wp_register_script("ultimate-modal-all",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/modal-all.min.js',array('jquery'),ULTIMATE_VERSION);
		}
...
//				}
			...
			if($modal_style == 'overlay-show-cornershape') {
				...
				$html .= "\n".'<div class="ult-overlay content-'.esc_attr($uniq).' '.esc_attr($el_class).'" data-class="content-'.esc_attr($uniq).'" id="button-click-overlay" style="'.$overlay_bg.' display:none;">';
			}
