...
if(!class_exists('Dfd_Testimonials')) 
{
	class Dfd_Testimonials{
		function __construct(){
			add_action('admin_init',array($this,'dfd_testimonials_init'));
					...
					array(
					   ...
					   'params' => array(
							...
							array(
								...
								"group" => "Typography",
								"dependency" => Array("element" => "testimonial_content_typography_type", "value" => array('google_fonts')),
							),
							array(
								'type' => 'textfield',
								...
								'value' => '',
								"group" => "Typography",
								"dependency" => Array("element" => "testimonial_content_typography_type", "value" => array('default')),
							),
							array(
