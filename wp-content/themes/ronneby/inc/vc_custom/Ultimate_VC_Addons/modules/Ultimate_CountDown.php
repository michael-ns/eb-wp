...
if(!class_exists('Ultimate_CountDown'))
{
	class Ultimate_CountDown
	{
		...
		function count_down_scripts() {
			wp_register_script("jquery.timecircle",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/jquery.countdown_org.min.js',array('jquery'),ULTIMATE_VERSION);
			wp_register_script("jquery.countdown",get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/assets/min-js/count-timer.min.js',array('jquery'),ULTIMATE_VERSION);
		}
