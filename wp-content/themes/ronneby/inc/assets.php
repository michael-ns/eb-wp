...
if (!function_exists('dfd_kadabra_scripts')) {
	...
	function dfd_kadabra_scripts() {
		...
		if (is_plugin_active('woocommerce/woocommerce.php')) {
			wp_register_style('dfd_wocommerce_style', get_template_directory_uri() . '/assets/css/woocommerce'.$dfd_multisite_file_option.'.css', false, null);
		...
		*/
		...
		wp_register_script('crum_effects', get_template_directory_uri() . '/assets/js/animation.min.js', false, null, true);
		wp_register_script('dfd_slide_parallax', get_template_directory_uri() . '/assets/js/jquery.slide_parallax.js', false, null, true);

		wp_register_script('smooth-scroll', get_template_directory_uri() . '/assets/js/jquery.smoothscroll.min.js', false, null, true);
		wp_register_script('crum_main', get_template_directory_uri() . '/assets/js/app.min.js', false, null, true);
		...
		wp_register_script('gmaps', '//maps.google.com/maps/api/js?sensor=false', false, null, false, true);
		wp_register_script('gmap3', get_template_directory_uri() . '/assets/js/gmap3.min.js', false, null, true, true);
		wp_deregister_script('prettyphoto');
		wp_register_script('prettyphoto', get_template_directory_uri() . '/assets/js/jquery.prettyPhoto.min.js', false, null, true, true);
		//wp_register_script('qr_code', get_template_directory_uri() . '/assets/js/qrcode.min.js', false, null, true);
		wp_register_script('custom-share', get_template_directory_uri() . '/assets/js/jquery.sharrre-1.3.4.min.js', array('jquery'), null, true);
...
//		wp_register_script('colpick', get_template_directory_uri() . '/stylechanges/colpick/js/colpick.js', false, null, true);
		...
		if(is_rtl()) {
			...
			wp_register_script('mega_menu_run', get_template_directory_uri().'/assets/js/jquery.mega-menu.run.min.js', false, null, true);
		}
		...
		wp_register_script('dfd-chaffle', get_template_directory_uri().'/assets/js/jquery.chaffle.min.js', array('jquery'), null, true);
		...
		if (strcmp($dfd_ronneby['scroll_animation'],'off')!==0) {
